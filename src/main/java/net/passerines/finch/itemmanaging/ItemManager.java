...
import net.passerines.finch.items.armor.impierceitems.impiercemage.ImpierceLeggings;
...
import net.passerines.finch.items.armor.impierceitems.impiercewarrior.ImpierceKneeplates;
