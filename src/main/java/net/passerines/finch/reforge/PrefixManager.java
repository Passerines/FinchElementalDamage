...
public class PrefixManager {
    ...
    public void registerPrefix(){
        ...
        new ItemPrefix("armorhard", "&8Hard", ItemPrefix.Type.ARMOR, 1, 0, 0, 50, 0);
        new ItemPrefix("armorreinforced", "&8Reinforced", ItemPrefix.Type.ARMOR ,2, 0, 0, 150, 0);
        new ItemPrefix("armorunyielding", "&dUnyielding", ItemPrefix.Type.ARMOR ,3, 200, 0, 175, 0);
        // ^armor
        ...
        new ItemPrefix("weaponcrude", "&7Crude", ItemPrefix.Type.WEAPON ,1, 0, 10, 0, -10);
        new ItemPrefix("weaponinfused", "&5Infused", ItemPrefix.Type.WEAPON ,2, 0, 0, 0, 350);
        new ItemPrefix("weaponatomizing", "&cAtomizing", ItemPrefix.Type.WEAPON, 3, 0, 250, 0, 0);
        // ^weapon
        ...
        new ItemPrefix("trinketmystical", Component.text("Mystical").color(TextColor.color(52, 76, 235)), ItemPrefix.Type.TRINKET, 3, 100, 0, 10, 1000);
        // ^trinket
    }
